<?php
/**
 * Zen Cart German Specific (zencartpro adaptations / 210 code in 157)
 * @copyright Copyright 2003-2025 Zen Cart Development Team
 * Zen Cart German Version - www.zen-cart-pro.at
 * @license https://www.zen-cart-pro.at/license/3_0.txt GNU General Public License V3.0
 * @version $Id: order.php for Edit Orders 2025-12-31 11:19:25Z webchills $
 */
/**
 * order class
 *
...
//          }
    ...
    $customer_address_query = "select c.customers_gender, c.customers_firstname, c.customers_lastname, c.customers_telephone,
                                    ...
                                    z.zone_code,z.zone_name, co.countries_id, con.countries_name,
        ...
        for ($i = 0, $n = count($products); $i < $n; $i++) {
            ...
            $this->products[$index] = [
                'qty' => $products[$i]['quantity'],
                                      ...
                                      'merkmale' => $products[$i]['merkmale'] ?? null,
                                      'model' => $products[$i]['model'],
                                      'image' => $products[$i]['image'] ?? null,  
