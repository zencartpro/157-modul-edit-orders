 ...
 */
define('MODULE_ORDER_TOTAL_ONETIME_DISCOUNT_TITLE', 'Einmaliger Rabatt');
define('MODULE_ORDER_TOTAL_ONETIME_DISCOUNT_DESCRIPTION', 'Einmaliger Rabatt für eine Bestellung');